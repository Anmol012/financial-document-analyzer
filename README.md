...
A production-grade full-stack application for analyzing financial documents using AI-powered agents. The system processes corporate reports, financial statements, and investment documents, providing insights, risk assessments, and visualizations. It includes a React-based frontend with TailwindCSS and shadcn/ui, and a FastAPI backend with MongoDB, Redis, and Celery for scalability and performance.
...
- File upload for financial documents (PDF only, <100MB)
- AI-powered document analysis using CrewAI
- Asynchronous analysis with Celery and Redis
...
- LLM observability for monitoring AI calls

### Frontend
- Modern, responsive UI with React, Vite, TailwindCSS, and shadcn/ui
- Dark theme with real-time file upload progress
- Interactive dashboards with charts (Recharts) for analysis results
- Document management (upload, view, delete, search)
...
financial-document-analyzer-debug-fullTime/
├── backend/
│   ├── app/
│   │   ├── extensions.py
│   │   ├── models.py
...
cd financial-document-analyzer-debug-fullTime
````
